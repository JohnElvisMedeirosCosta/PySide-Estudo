...
################################################################################
## Form generated from reading UI file 'pagesiIVzjN.ui'
##
...
class Ui_application_pages(object):
    def setupUi(self, application_pages):
        ...
        application_pages.resize(1063, 610)
        self.page_1 = QWidget()
...
"}")
    ...
    def retranslateUi(self, application_pages):
        ...
        self.label.setText(QCoreApplication.translate("application_pages", u"Ol\u00e1...", None))
